...
export const transactions: Transaction[] = [
  ...
  { id: 'TXN-005', userId: 'USR-8921', userName: 'Rohit Gupta', amount: 67800, riskScore: 65, fraudSignals: ['GeoMismatch', 'HighAmount', 'HighRefundFrequency'], status: 'Pending', type: 'Card', timestamp: '2024-12-15 10:42', coordinates: { lat: 12.9716, lng: 77.5946 }, city: 'Bangalore' },
...
export const inboundRequests: InboundRequest[] = [
  ...
  { id: 'REQ-005', sourceWebsiteUrl: 'https://megastore.in', orderId: 'ORD-33421', userId: 'USR-8921', refundReason: 'Duplicate charge', amount: 67800, timestamp: '2024-12-15 09:45', status: 'Pending', fraudSignals: ['HighRefundFrequency', 'HighAmount'], riskScore: 35, customerName: 'Rohit Gupta', customerEmail: 'rohit.g@workmail.com' },
  ...
  { id: 'REQ-011', sourceWebsiteUrl: 'https://urbanbasket.com', orderId: 'ORD-62759', userId: 'USR-7634', refundReason: 'Partial order missing', amount: 5400, timestamp: '2024-12-14 14:40', status: 'Pending', fraudSignals: [], riskScore: 0, customerName: 'Vikram Singh', customerEmail: 'vikram.s@testmail.com' },
  { id: 'REQ-012', sourceWebsiteUrl: 'https://quickmart.co', orderId: 'ORD-19384', userId: 'USR-2109', refundReason: 'Charged after cancellation', amount: 27600, timestamp: '2024-12-14 11:15', status: 'Analyzing', fraudSignals: ['HighRefundFrequency'], riskScore: 25, customerName: 'Ananya Reddy', customerEmail: 'ananya.reddy@mail.com' },
];
